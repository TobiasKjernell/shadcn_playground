        ...
        <div>
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>Tobbe</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg">
                        ...
                        <div className="space-y-4 mt-4">
                            ...
                            <div className=" flex items-center gap-2">
                                ...
                                <span className="">Tobbe</span>
                            </div>
                            <div className=" flex items-center gap-2">
                                <span className="font-bold">Email</span>
                                <span className="">Tobbe@psp.com</span>
                            </div>
                            <div className=" flex items-center gap-2">
                                <span className="font-bold">Phone</span>
                                <span className="">076-12345678</span>
                            </div>
                            <div className=" flex items-center gap-2">
                                <span className="font-bold">Location</span>
                                <span className="">Stockholm, Sweden</span>
                            </div>
                            <div className=" flex items-center gap-2">
                        ...
                        <p className="text-sm text-muted-foreground mt-4">Joined on 2025.29.11</p>
                    </div>
                    {/* CARDLIST */}
                    <div className="bg-primary-foreground p-4 rounded-lg">
                ...
                <div className="w-full xl:w-2/3 space-y-6">
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-xl font-semibold">Tobbe</h1>
                        </div>
                        <p className="text-sm text-muted-foreground">
